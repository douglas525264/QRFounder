...
#define MS_Test_PublishID        @"lZSVRvoBGI+mRrnPEg=="
#define MS_Test_SlotToken_Banner @"MDEw41+nvSoD4xxqt6PrDbwW"//横幅广告位
#define MS_Test_SlotToken_Poster @"EhMSwX2FnwghwT5IlYHJL541"//全屏广告位
#define MS_Test_SlotToken_Splash @"o6KjcMw0LrmQcI/5JDB4ni+H"//开屏广告位
#define MS_Test_SlotToken_Native @"mJmYS/cPFYKrS7TCHwtDpRS2"//信息流广告位
#define MS_TEST_AUDIT_FLAG @"IOS_AppStore_V1.0.0"
